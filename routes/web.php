...
Route::post('change_city','App\Http\Controllers\LeadController@change_city')->name('change_city');
...
Route::resource('rfields', 'App\Http\Controllers\RfieldController');
Route::post('cfields', 'App\Http\Controllers\RfieldController@cfields')->name('cfields');
